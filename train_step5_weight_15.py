...
def get_args():
    ...
    parser.add_argument('--fname', default='cifar_model_step5_weight_15', type=str)
...
def main():
    ...
    wp_adversary = WeightPerturb(model=model, proxy_1=proxy_proxy, proxy_2=proxy, proxy_2_optim=proxy_opt, gamma=args.wp_gamma)
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, batch in enumerate(train_batches):
            ...
            if epoch >= args.wp_warmup:
                ...
                wp = wp_adversary.calc_wp(inputs_adv=X_adv, targets=y, threshold=1.5)
